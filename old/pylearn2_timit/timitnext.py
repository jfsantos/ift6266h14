...
class TIMITnext(Dataset):
    ...
    def __init__(self, which_set, frame_length, overlap=0,
        ...
        for i, sequence in enumerate(self.raw_wav):
            self.raw_wav[i] = (sequence - TIMITnext._mean) / TIMITnext._std
        ...
        targets_space = VectorSpace(dim=1)
...
if __name__ == "__main__":
    ...
    valid_timit = TIMITnext("valid", frame_length=1, overlap=0,
